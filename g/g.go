...
func init() {
	...
	BinOf = map[string]string{
		...
		"sender-plus": "./sender-plus/bin/falcon-sender-plus",
	}
	...
	cfgOf = map[string]string{
		...
		"sender-plus": "./sender-plus/config/cfg.json",
	}
	...
	ModuleApps = map[string]string{
		...
		"api":         "falcon-api",
		"alarm":       "falcon-alarm",
		"sender-plus": "falcon-sender-plus",
	}
	...
	logpathOf = map[string]string{
		...
		"sender-plus": "./sender-plus/logs/sender-plus.log",
	}
